...
function ListView.new(name, parent, scrollDirection)
    ...
    if scrollDirection == "VERTICAL" then
        ...
        name, parentComponent, "ui/campaign ui/finance_screen", "TabGroup",
            "tab_trade", "trade", "tradeTabGroup", "producing", "produce_window", "listview"
        );
...
function ListView.AddContainer(self, container)
    ...
    local dummy = Dummy.new(cm:ui_root());
